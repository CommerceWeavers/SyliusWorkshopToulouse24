...
namespace Acme\SyliusAwesomePlugin\Controller;
...
final class GreetingController extends AbstractController
{
    ...
    {
        return $this->render('@AcmeSyliusAwesomePlugin/static_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }

    public function dynamicallyGreetAction(?string $name): Response
    {
        return $this->render('@AcmeSyliusAwesomePlugin/dynamic_greeting.html.twig', ['greeting' => $this->getGreeting($name)]);
    }
